...
- Retention: **3 daily + 4 weekly + 3 monthly**. The first backup in each ISO
  week is promoted to `weekly/`; the first backup in each month's first seven days is promoted to
