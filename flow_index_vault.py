...
def _save_degraded_unresolved(index_root: Path, ledger: dict) -> None:
    try:
...
def index_vault_flow(
    ...
    if degraded_report["total"]:
        ...
        logger.info(
            ...
            "%d capped, %d source not scanned, %d unresolved",
        ...
        if degraded_report["terminal"]:
            ...
            _save_degraded_unresolved(index_root, unresolved_ledger)
            logger.error(
