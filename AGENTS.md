...
This project is indexed by GitNexus as **RAG-in-a-Box** (3406 symbols, 9054 relationships, 242 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
