...
This project is indexed by GitNexus as **RAG-in-a-Box** (3439 symbols, 9151 relationships, 245 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
