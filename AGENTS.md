...
This project is indexed by GitNexus as **RAG-in-a-Box** (2044 symbols, 5534 relationships, 155 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
