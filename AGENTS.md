...
This project is indexed by GitNexus as **RAG-in-a-Box** (3653 symbols, 9821 relationships, 255 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
