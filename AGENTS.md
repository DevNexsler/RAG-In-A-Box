...
This project is indexed by GitNexus as **RAG-in-a-Box** (2722 symbols, 7320 relationships, 213 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
