...
This project is indexed by GitNexus as **RAG-in-a-Box** (4650 symbols, 13011 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
