...
This project is indexed by GitNexus as **RAG-in-a-Box** (1934 symbols, 5289 relationships, 151 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
