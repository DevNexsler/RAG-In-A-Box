...
This project is indexed by GitNexus as **RAG-in-a-Box** (2255 symbols, 6124 relationships, 178 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
